...
import com.posp.oos.web.srv.model.vo.res.old.body.UpdateAgentBodyResVo;
...
@Data
@ApiModel(description = "修改代理商响应")
public class UpdateAgentResVo {
    ...
    private UpdateAgentBodyResVo body;
