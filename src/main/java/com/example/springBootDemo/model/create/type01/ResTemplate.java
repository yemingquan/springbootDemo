 ...
 */
@Data
public class ResTemplate extends BaseClassInfo {
    {
        this.setClassNameSuffex(TemplateType01.TYPE01_RES_CLASS_NAME_SUFFEX);
        resHeadTemplate = new ResHeadTemplate();
        resBodyTemplate = new ResBodyTemplate();
    }

    private ResHeadTemplate resHeadTemplate;
    private ResBodyTemplate resBodyTemplate;
    ...
    public Map initTemplate(Map map, FileCreater creater) throws Exception {
        ...
        packagePathTemplateSb.append(TemplateType01.TYPE01_RES_PACKAGE_PATH_SUFFIX);
        //class
        StringBuilder classNameTemplateSb = new StringBuilder();
        classNameTemplateSb.append(TemplateType01.TYPE01_RES_CLASS_NAME_SWAGGER).append(TemplateType01.TYPE01_MESSAGE_CLASS_NAME_01).append(TemplateType01.TYPE01_MESSAGE_CLASS_NAME_02);
        ...
        StringBuilderUtil.replaceAll(fieldTemplateSb, TemplateType01.TEMPLATE_FIELD_TYPE_NAME, classInfoMap.get("^resHeadName$"));
        ...
        StringBuilderUtil.replaceAll(fieldTemplateSb, TemplateType01.TEMPLATE_FIELD_TYPE_NAME, classInfoMap.get("^resBodyName$"));
...
//        methodListTemplate = methodListTemplateSb.toString();
        ...
        returnMap.put(TemplateType01.TEMPLATE_RES_CLASS_NAME_NAME,className);
    ...
    public void toCreater(FileCreater creater) throws Exception {
        classInfoMap.putAll(resBodyTemplate.initTemplate(classInfoMap, creater));

        creater.addCreateFile(resBodyTemplate);
    }
}
