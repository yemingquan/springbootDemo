 ...
 */
@Data
public class ResBodyTemplate extends BaseClassInfo {
    {
        this.setClassNameSuffex(TemplateType01.TYPE01_RES_BODY_CLASS_NAME_SUFFEX);
    }
    ...
    public Map initTemplate(Map map, FileCreater creater) {
        ...
        packagePathTemplateSb.append(TemplateType01.TYPE01_RES_BODY_PACKAGE_PATH_SUFFIX);
        //class
        StringBuilder classNameTemplateSb = new StringBuilder();
        classNameTemplateSb.append(TemplateType01.TYPE01_RES_BODY_CLASS_NAME_SWAGGER).append(TemplateType01.TYPE01_MESSAGE_CLASS_NAME_01).append(TemplateType01.TYPE01_MESSAGE_CLASS_NAME_02);
        ...
        fieldListTemplate = classInfoMap.get("resBodyFieldListTemplate");

        returnMap.put("^resBodyName$",className);
